			  ...
			  implements Handler.Callback, MyAppObserver
{
	...
	public void onReceive(Context context, Intent intent) {
	   // if (isNetworkChange(context)) //fofe
      if(true)
		notifyChangeNetwork();
	}
...
super.onCreate(savedInstanceState);
        Log.e("TEST FOFE","before launch activity_main3");
        try {
			setContentView(R.layout.activity_main);

        Log.e("TEST FOFE","after launch activity_main3");
	if (app == null) {
		Log.e("TEST FOFE","before instancing app");
		try {
			app = new MyApp();
		}catch (Exception e){
		}
		Log.e("TEST FOFE","instancing app");
	...
	if (receiver == null) {
		...
		Log.e("TEST FOFE","before registrer method action");
...
//finish();
    ...
    */
	...
	public void  registrer(){
		...
		String acc_id 	 =  "sip:300@192.168.43.106";// etId.getText().toString();
		String registrar =  "sip:192.168.43.106";//etReg.getText().toString();
		String proxy 	 = "";//etProxy.getText().toString();
		String username  = "300";//etUser.getText().toString();
		String password  = "poseidon";//etPass.getText().toString();
